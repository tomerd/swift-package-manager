...
extension PackageDependencyDescription {
    ...
    public func createPackageRef() -> PackageReference {
        ...
        return PackageReference(
            ...
            //path: effectiveURL,
            // FIXME: change PackageReference path to URL
            path: self.location.absoluteString,
            kind: self.requirement == .localPackage ? .local : .remote
        )
    }
}
...
extension PackageReference {
    ...
    public var repository: RepositorySpecifier {
        ...
        // FIXME: change RepositorySpecifier url to URL
