...
let loadedPackage = try tsc_await { PackageBuilder.loadPackage(at: packagePath, kind: .local, swiftCompiler: swiftCompiler, swiftCompilerFlags: [], diagnostics: diagnostics, on: .global(), completion: $0) }
